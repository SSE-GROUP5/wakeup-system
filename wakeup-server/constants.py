...
HOMEASSITANT_OFFLINE_MODE = os.getenv("HOMEASSITANT_OFFLINE_MODE").lower() == "true" if os.getenv("HOMEASSITANT_OFFLINE_MODE") != None else False
...
if HOMEASSITANT_OFFLINE_MODE == True:
